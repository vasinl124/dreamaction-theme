...
*/
	...
	insertGooglePhotos = function(response,$photomaxContainer,createFlag,loadMoreFlag,paginateFlag) {
		//console.log("insertGooglePhotos");
		//console.log(response);
		var $photomaxContainerList = $photomaxContainer.find('ul');
		var item = '';
		//console.log('loadMoreFlag-'+loadMoreFlag);
		...
		$photomaxContainerList.imagesLoaded().always(function() {
			...
			if(itemType=="album") {
				...
				$items.find('.photomax-main-thumbnail').click(function(){
					...
					displayItems(photomaxPlaylistId,$photomaxContainer,true);
	...
	displayItems = function(tabId,$photomaxContainer,showCustomTab) {
    ...
    $.fn.photomax = function(options) {
		...
		//added in 3.0
		photomax_global_options.tabStyle = options.tabStyle||"block"; //block or wire 

		photomax_global_options.tabBackgroundColor = options.tabBackgroundColor||"#f5f5f5"; 
		photomax_global_options.tabTextColor = options.tabTextColor||"#929090"; 
		
		photomax_global_options.tabHoverColor = options.tabHoverColor||"rgba(106, 106, 106, 0.09)"; 

		photomax_global_options.tabActiveBackgroundColor = options.tabActiveBackgroundColor||"#ACACAC"; 
		photomax_global_options.tabActiveTextColor = options.tabActiveTextColor||"white"; 

		photomax_global_options.photomaxBackgroundColor = options.photomaxBackgroundColor||"#e2e2e2"; 

		photomax_global_options.headerStyle = options.headerStyle||"block"; //block or open 

		photomax_global_options.loadmoreButtonBackgroundColor = options.loadmoreButtonBackgroundColor||"rgb(212, 212, 212)"; 
		photomax_global_options.loadmoreButtonTextColor = options.loadmoreButtonTextColor||"#666"; 
		photomax_global_options.loadmoreButtonHoverBackgroundColor = options.loadmoreButtonHoverBackgroundColor||"#383838"; 
		photomax_global_options.loadmoreButtonHoverTextColor = options.loadmoreButtonHoverTextColor||"white"; 

		photomax_global_options.gridItemBackgroundColor = options.gridItemBackgroundColor||"white"; 
		photomax_global_options.gridItemSeparatorColor = options.gridItemSeparatorColor||"#e2e2e2"; 
		photomax_global_options.gridItemTextColor = options.gridItemTextColor||"#666"; 
		//photomax_global_options.gridItemTitleColor = options.gridItemTitleColor||"#5781d4"; 
		photomax_global_options.gridItemLinkColor = options.gridItemLinkColor||"#5781dc"; 
		photomax_global_options.gridItemIconColor = options.gridItemIconColor||"#b0b0af"; 

		//photomax_global_options.gridItemSecondaryBackgroundColor = options.gridItemSecondaryBackgroundColor||"#f7f6f6"; 
		photomax_global_options.gridItemSecondaryTextColor = options.gridItemSecondaryTextColor||"#c9c9c9"; 
		photomax_global_options.gridItemSecondaryIconColor = options.gridItemSecondaryIconColor||"#7d7a7a"; 
		...
		custom_styles += '.photomax,#photomax-video-list-div{background-color:'+photomax_global_options.photomaxBackgroundColor+';}';
		
		//tab colors
		if(photomax_global_options.tabStyle=="block") {
		
			custom_styles += '#photomax-tabs{background-color:'+photomax_global_options.tabBackgroundColor+';}';
			custom_styles += '.photomax-tab{color:'+photomax_global_options.tabTextColor+';}';

			custom_styles += '.photomax-tab:hover{background-color:'+photomax_global_options.tabHoverColor+';}';

			custom_styles += '.photomax-tab.photomax-tab-hover{background-color:'+photomax_global_options.tabActiveBackgroundColor+';}';
			custom_styles += '.photomax-tab-hover{color:'+photomax_global_options.tabActiveTextColor+';}';
		
		
		} else {

			custom_styles += '#photomax-tabs{background-color:'+photomax_global_options.photomaxBackgroundColor+';}';
			custom_styles += '#photomax-tabs{border-bottom: 1px solid '+photomax_global_options.tabBackgroundColor+';}';
			custom_styles += '#photomax-tabs{display: inline-block;width: 100%;box-sizing: border-box;padding: 0px 25px;}';


			custom_styles += '.photomax-tab {float: left;margin: 0px;padding: 16px 14px;}';
			custom_styles += '.photomax-tab{color:'+photomax_global_options.tabTextColor+';}';

			custom_styles += '.photomax-tab:hover{color:'+photomax_global_options.tabHoverColor+';}';

			custom_styles += '.photomax-tab-hover{border-bottom: 1px solid '+photomax_global_options.tabActiveBackgroundColor+';}';
			custom_styles += '.photomax-tab.photomax-tab-hover{color:'+photomax_global_options.tabActiveTextColor+';}';

		}

		//loading button colors
		custom_styles += '#photomax-next-div,#photomax-previous-div,#photomax-load-more-div{background-color:'+photomax_global_options.loadmoreButtonBackgroundColor+';}';
		custom_styles += '#photomax-next-div,#photomax-previous-div,#photomax-load-more-div{color:'+photomax_global_options.loadmoreButtonTextColor+';}';

		custom_styles += '#photomax-next-div:hover,#photomax-previous-div:hover,#photomax-load-more-div:hover,#photomax-load-more-div.photomax-load-more-div-click,#photomax-next-div.photomax-load-more-div-click,#photomax-previous-div.photomax-load-more-div-click{background-color:'+photomax_global_options.loadmoreButtonHoverBackgroundColor+';}';
		custom_styles += '#photomax-next-div:hover,#photomax-previous-div:hover,#photomax-load-more-div:hover,#photomax-load-more-div.photomax-load-more-div-click,#photomax-next-div.photomax-load-more-div-click,#photomax-previous-div.photomax-load-more-div-click{color:'+photomax_global_options.loadmoreButtonHoverTextColor+';}';

		//Grid Item Colors
		custom_styles += "#tiles li p{background-color:"+photomax_global_options.gridItemBackgroundColor+";}";
		custom_styles += "span.photomax-view-date-holder{border-top:1px solid "+photomax_global_options.gridItemSeparatorColor+";}";
		if(photomax_global_options.skin=="trend1") {
			custom_styles += "span.photomax-title-desc-holder {border-bottom: 1px solid "+photomax_global_options.gridItemSeparatorColor+";}";
		}
		
		//custom_styles += ".photomax-video-list-title{color:"+photomax_global_options.gridItemTitleColor+";}";
		custom_styles += ".photomax-title-desc-holder a{color:"+photomax_global_options.gridItemLinkColor+";}";
		custom_styles += ".photomax-video-list-description{color:"+photomax_global_options.gridItemTextColor+";}";
		custom_styles += ".photomax-video-list-date,.photomax-view-date-holder{color:"+photomax_global_options.gridItemTextColor+";}";
		custom_styles += ".photomax-view-date-holder i{color:"+photomax_global_options.gridItemIconColor+";}";
		

		//Secondary colors

		//trend link
		custom_styles += ".photomax-thumbnail-link{color:"+photomax_global_options.gridItemSecondaryIconColor+"}";
		custom_styles += ".photomax-link{border-color:"+photomax_global_options.gridItemSecondaryTextColor+"}";
		//block likes & comments
		custom_styles += ".photomax-like-comment-holder i{color:"+photomax_global_options.gridItemSecondaryIconColor+"}";
		custom_styles += ".photomax-like-comment-holder {color:"+photomax_global_options.gridItemSecondaryTextColor+"}";
		custom_styles += ".photomax-like-comment-holder {background-color:"+photomax_global_options.gridItemSecondaryBackgroundColor+"}";
